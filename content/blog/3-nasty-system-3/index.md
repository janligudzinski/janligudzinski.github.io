...
[^3]: This dumb term here comes from my hurried business analysis early on in the project - the domain term actually used in Polish is "wspólnota \[mieszkaniowa\]", which early on I understood as equivalent to a "spółdzielnia", what would in English be a "cooperative" literally and a "condo administration" idiomatically, but what would actually work better in English here is just "building". I could actually rename this since I don't have an actual team under me.\
