...
[^3]: Considering that every user account has a valid email and we ourselves manage registration - you can't just "click yourself" into being an end-user either - a much better flow would have been to simply send every newly registered account a long-lived password reset link in a welcome email. We'll do this Later (TM).
